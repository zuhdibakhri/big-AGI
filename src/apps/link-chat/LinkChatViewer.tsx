  ...
  return (
    ...
    >
      ...
      >
        <CardContent sx={{ gap: 1 }}>
          ...
          <Typography level="body-xs">
            ...
            {!!props.expiresAt && (
              <>
                , expires <TimeAgo date={props.expiresAt} />
              </>
            )}
            .
          </Typography>
        ...
        <WorkspaceIdProvider conversationId={null}>
          <ScrollToBottom bootToBottom bootSmoothly>
            ...
            >
              ...
              >
                <Typography level="body-md">Welcome to the chat! 👋</Typography>
              </ListItem>
      ...
      <Box sx={{ display: 'flex', flexFlow: 'row wrap', alignItems: 'center', justifyContent: 'center', gap: 2 }}>
        ...
        >
          {hasExistingChat ? `Import as New` : `Import on ${Brand.Title.Base}`}
        </Button>
