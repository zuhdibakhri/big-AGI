...
export function BlockEdit_TextFragment(props: {
  ...
  // handlers
  const handleEditTextChanged = React.useCallback(
    ...
    (e: React.KeyboardEvent<HTMLTextAreaElement>) => {
      if (e.key === 'Enter') {
        ...
        if (enterIsNewline ? shiftOrAlt : !shiftOrAlt) {
          e.preventDefault();
          if (!withControl || props.enableRestart) onSubmit(withControl);
        }
          ...
          : [
              {
                ...
                shift: true,
                description: 'Save',
                disabled: !isEdited && props.enableRestart !== true,
                level: 3,
  ...
  return (
    <BlocksTextarea
      ...
      value={props.editedText !== undefined ? props.editedText /* self-text */ : props.textPartText /* DMessageTextPart text */}
