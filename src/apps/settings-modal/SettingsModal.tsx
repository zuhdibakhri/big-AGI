...
export function SettingsModal(props: {
  ...
  const handleSetTab = React.useCallback(
    (_event: any, value: string | number | null) => {
  ...
  return (
    ...
    >
      ...
      <Tabs aria-label="Settings tabbed menu" value={props.tab || 'chat'} onChange={handleSetTab}>
        <TabList
          disableUnderline
          sx={{
